...
def draw(array,i,style):
    ...
    if style == 'solid':
        currentAxis.annotate('R' + str(i+5), (x + width/2, y + height/2), color='black', weight='bold', fontsize=12, ha='center', va='center')
    #else:
    #    currentAxis.annotate('R' + str(i+1), (x + width/2, y + height/2), color='black', weight='bold', fontsize=12, ha='center', va='center')
